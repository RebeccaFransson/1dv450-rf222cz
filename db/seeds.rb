...
user = User.create(name: "Rebecca", email: "rebecca@awesome.se", isAdmin: false)
app = App.create(user_id: user.id, app_name: "Twitter", key: "DGDF2131SGFsfdSDF") #

user2 = User.create(name: "Karin", email: "karin@awesome.se", isAdmin: false)
...
user3 = User.create(name: "Admin", email: "admin@awesome.se", isAdmin: true)
